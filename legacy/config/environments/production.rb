Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "cocktailperlen_#{Rails.env}"
  ...
  config.middleware.use ExceptionNotification::Rack,
                        :email => {
                            :email_prefix => "[CS] ",
                            :sender_address => %{"CS Error Notifier" <webmaster@example.com>},
                            :exception_recipients => %w{example@example.com}
                        }
