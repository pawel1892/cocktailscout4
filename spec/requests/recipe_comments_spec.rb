    ...
    context "when user is authenticated" do
      ...
      context "with valid parameters" do
        ...
        it "creates a new comment" do
          expect {
            post comment_recipe_path(recipe), params: valid_params
      ...
      context "with invalid parameters" do
        context "when body is empty" do
          ...
          it "does not create a new comment" do
            expect {
              post comment_recipe_path(recipe), params: invalid_params
      ...
      context "when recipe does not exist" do
        it "returns 404 not found" do
          post comment_recipe_path("non-existent"), params: { recipe_comment: { body: "Test" } }
